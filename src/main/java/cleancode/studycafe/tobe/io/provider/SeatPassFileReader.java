...
public class SeatPassFileReader implements SeatPassProvider {
    ...
    private static final String PATH_LIST_CSV_PATH = "src/main/resources/cleancode/studycafe/pass-list.csv";

    @Override
    public StudyCafeSeatPasses getSeatPasses() {
        try {
            List<String> lines = Files.readAllLines(Paths.get(PATH_LIST_CSV_PATH));
